...
\centro{ICOMP -- Instituto de Computação}
% \departamento{Departamento de ...}
\local{Manaus}
\data{\today}

\autor{Prof. Anderson \textsc{Pimentel dos Santos}, Ms.}

\tipotrabalho{Notas de Aula}
\disciplina{}
\codigo{} % Código da disciplina
\area{Informática / Introdução à Programação de Computadores}
\semestre{2018/1}
\aula{Aula 01}
\titulo{Programação de Computadores: Estruturas Condicionais}

\preambulo{}

\email{apds.anderson@icomp.ufam.edu.br}
\telefone{Tel: +55 (92) 993531716}
\celular{Cel: +55 (92) 993531716}
\website{\url{http://www.caua.me}}
\laboratorio{GTI -- Grupo de Tratamento de Informação}
\campus{Campus Universitário – Manaus, Amazonas}
